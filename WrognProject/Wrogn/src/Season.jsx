...
const Season = () => {
    return (
        <div className="bg-white py-7 space-y-10">
            <h2 className="text-center font-bold text-2xl mb-4 mt-20">VIRAT HAS A MESSAGE FOR YOU</h2>
            <div className="bg-[#f3f3f3] max-w-7xl mx-auto rounded-2xl pb-1">
                ...
                <div className="bg-white rounded-3xl mx-1 mt-1">
                    ...
                    <div className="max-w-7xl h-[515px] mx-auto px-2">
                        <div className="flex justify-between items-center mb-4 px-4">
                            <button className="custom-prev text-3xl font-semibold relative top-[180px] left-[-20px] z-50 w-[40px] h-[50px] bg-gray-200 rounded-xl hover:bg-gray-300 transition">
                                ‹
                            </button>
                            <button className="custom-next text-3xl font-semibold relative top-[180px] left-[15px] z-50 w-[40px] h-[50px] bg-gray-200 rounded-xl hover:bg-gray-300 transition">
                                ›
                            </button>
                        </div>
                        <Swiper
                        ...
                        >
                            {products.map((product) => (
                                <SwiperSlide key={product.id}>
                                    <div className="bg-white  rounded-xl shadow-sm p-2 relative bottom-55 min-w-[260px] max-w-[280px]">
                                        <div className="relative">
                                            <img
                                                style={{ height: "280px", width: "250px", borderRadius: "15px" }}
                                                src={product.image}
                                                alt={product.title}
                                            />
                                            {product.tag && (
                                        ...
                                        <div className="mt-2 px-2 space-y-1">
                                            ...
                                            <button className="w-full h-[50px] font-bold mt-2 border border-black text-sm py-1 rounded hover:bg-black hover:text-white transition">
                                                Add to Bag
                                            </button>
                                        </div>
                                    </div>
